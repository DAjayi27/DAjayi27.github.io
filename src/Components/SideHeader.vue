<script>
    ...
    import data from "../assets/json/sideBarOptions.json";
    ...
    export default{
        ...
        methods :{
            ...
            test(e){
                ...
                const currentHeight = element.style.getPropertyValue('max-height');
                if (currentHeight) {
...
<template>
    ...
    <div class="sidebar" id="sidebar">
        <div class="hamburger">
            <p>Darasimi Ajayi </p>
            <font-awesome-icon icon="fa-solid fa-bars"  @click="test" size="2xl" class="icon"/>
        </div>
...
<style src="../assets/css/sideHeader.css">
